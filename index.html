						...
						<div class="media">
							...
							<div class="media-body">
								<div class="personal_text">
									...
									<h3>Rikza Priyudha Hirdad</h3>
									<h4>Junior Web Developer</h4>
									<p>You will begin to realise why this exercise is called the Dickens Pattern (with reference to the ghost showing Scrooge some different futures)</p>
									<ul class="list basic_info">
										<li><a href="#"><i class="lnr lnr-calendar-full"></i> 19st May, 1997</a></li>
										<li><a href="#"><i class="lnr lnr-phone-handset"></i> +62 822 3693 7528</a></li>
										<li><a href="#"><i class="lnr lnr-envelope"></i> rikza79@gmail.com</a></li>
